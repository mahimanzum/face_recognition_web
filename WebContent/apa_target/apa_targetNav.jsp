...
<%@ page import="apa_target.Apa_targetAnotherDBDAO"%>
		...
		<div class="form-horizontal">
			<div class="form-body">
				<div class="col-10">
					...
					<div class="col-lg-3">
						<div class="row">
							<label for="" class="control-label col-4"><%=LM.getText(LC.GLOBAL_RECORD_PER_PAGE, loginDTO)%></label>
							<div class="col-8">
					...
					<div class="col-lg-3">
						<div class="row">
							<label for="" class="control-label col-4"><%=LM.getText(LC.APA_TARGET_SEARCH_ANYFIELD, loginDTO)%></label>
							<div class="col-8">
					...
					<div class="col-lg-3">
						<div class="row">
							<label for="" class="control-label col-4"><%=LM.getText(LC.APA_TARGET_SEARCH_SEMENCOLLECTION, loginDTO)%></label>
							<div class="col-8">
								<input type="text" class="form-control" id="semen_collection" placeholder="" name="semen_collection" onkeyup="allfield_changed()">
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="row">
							<label for="" class="control-label col-4"><%=LM.getText(LC.APA_TARGET_SEARCH_ARTIFICIALINSEMENATION, loginDTO)%></label>
							<div class="col-8">
								<input type="text" class="form-control" id="artificial_insemenation" placeholder="" name="artificial_insemenation" onkeyup="allfield_changed()">
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="row">
							<label for="" class="control-label col-4"><%=LM.getText(LC.APA_TARGET_SEARCH_PROGENY, loginDTO)%></label>
							<div class="col-8">
								<input type="text" class="form-control" id="progeny" placeholder="" name="progeny" onkeyup="allfield_changed()">
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="row">
							<label for="" class="control-label col-4"><%=LM.getText(LC.APA_TARGET_SEARCH_CANDIDATEBULLPRODUCTION, loginDTO)%></label>
							<div class="col-8">
								<input type="text" class="form-control" id="candidate_bull_production" placeholder="" name="candidate_bull_production" onkeyup="allfield_changed()">
							</div>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="row">
							<label for="" class="control-label col-4"><%=LM.getText(LC.APA_TARGET_SEARCH_DESCRIPTION, loginDTO)%></label>
							<div class="col-8">
					...
					<div class="col-lg-3">
						<div class="row">
							<label for="" class="control-label col-4"><%=LM.getText(LC.APA_TARGET_SEARCH_ENTRYDATE, loginDTO)%></label>
							<div class="col-8">
