...
<%@ page import="centre.CentreAnotherDBDAO"%>
		...
		<div class="form-horizontal">			
			<div class="form-body">
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.CENTRE_SEARCH_NAMEEN, loginDTO)%></label>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.CENTRE_SEARCH_NAMEBN, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.CENTRE_SEARCH_ADDRESS, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.CENTRE_SEARCH_CONTACTPERSON, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.CENTRE_SEARCH_PHONENUMBER, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<input type="number" class="form-control" id="phone_number" placeholder="" name="phone_number">
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.CENTRE_SEARCH_EMAIL, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.CENTRE_SEARCH_DESCRIPTION, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
