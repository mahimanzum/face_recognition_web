...
%>
	<jsp:include page="../includes/custom_search_nav.jsp" flush="true">
		...
		<jsp:param name="pageName" value="<%=LM.getText(LC.REPORT_SEARCH_REPORT_SEARCH_FORMNAME, loginDTO)%>" />
	</jsp:include>
<%String context = "../../.."  + request.getContextPath() + "/";%>

<div class="portlet box">
	<div class="portlet-body">
		<form action="ReportServlet?actionType=delete" method="POST" id="tableForm" enctype = "multipart/form-data">
			<jsp:include page="reportSearchForm.jsp" flush="true">
				<jsp:param name="pageName" value="<%=LM.getText(LC.REPORT_SEARCH_REPORT_SEARCH_FORMNAME, loginDTO)%>" />
			</jsp:include>	
		</form>
	</div>
