				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_COLLECTION_SEARCH_BULLTYPE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<select class='form-control'  name='bull_type' id = 'bull_type' >
<%
			
			Options = Semen_collectionAnotherDBDAO.getOptions(Language, "select", "bull", "bullType_select_" + row, "form-control", "bullType", "any" );			
			out.print(Options);
%>
</select>
							</div>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_COLLECTION_SEARCH_NOOFDOSE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_COLLECTION_SEARCH_VOLUME, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_COLLECTION_SEARCH_DENSITY, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<input type="text" class="form-control" id="density" placeholder="" name="density">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_COLLECTION_SEARCH_PROGRESSIVEMORTALITY, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<input type="text" class="form-control" id="progressive_mortality" placeholder="" name="progressive_mortality">
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_COLLECTION_SEARCH_COLORTYPE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<select class='form-control'  name='color_type' id = 'color_type' >
<%
			
			Options = Semen_collectionAnotherDBDAO.getOptions(Language, "select", "color", "colorType_select_" + row, "form-control", "colorType", "any" );			
			out.print(Options);
%>
</select>
							</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_COLLECTION_SEARCH_TRANSACTIONDATE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_COLLECTION_SEARCH_DESCRIPTION, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
