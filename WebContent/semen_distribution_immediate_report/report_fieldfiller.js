...
function PreprocessBeforeSubmiting(row, validate)
{
	...
	console.log("document.getElementById('transactionDate_date_' + row).value" + document.getElementById('transactionDate_date_' + row).value);
	if(document.getElementById('transactionDate_date_' + row).value  == '0')
	{
		console.log("clearing 0 value");
		document.getElementById('transactionDate_date_' + row).value = "";
	}
	return true;
}
