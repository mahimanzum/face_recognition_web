...
<form class="form-horizontal" id="ReportForm"
			action="<%=request.getContextPath()%>/Semen_distribution_immediate_report_Servlet?actionType=<%=ActionTypeConstant.REPORT_RESULT%>">
<div class="portlet box portlet-btcl">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-cubes"></i><%=LM.getText(LC.SEMEN_DISTRIBUTION_IMMEDIATE_REPORT_OTHER_REPORT_GENERATION, loginDTO)%>
		</div>
	</div>
	<div class="portlet-body form">
		
			<input type="hidden" id="countURL" name="countURL" value="/Semen_distribution_immediate_report_Servlet?actionType=<%=ActionTypeConstant.REPORT_COUNT%>">
			<div class="form-body">
				<div class="row">
<!--  					<div class="col-md-6">
						<div class="col-md-8">
				...
				<div id="searchCriteria" hide = "false">
					<%@include file="semen_distribution_immediate_report_SearchDiv.jsp"%>
				</div>
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="icon-settings"></i> <span id = "report-name"
								...
								<%=LM.getText(LC.SEMEN_DISTRIBUTION_IMMEDIATE_REPORT_OTHER_SEMEN_DISTRIBUTION_IMMEDIATE_REPORT, loginDTO)%> by <%=userfullName%>, <%=centreName%>
								</span>
						</div>
						<div class="tools"></div>
					</div>
