<jsp:include page="../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../yearly_candidate_bull_production_report/yearly_candidate_bull_production_report_Body.jsp" />
	<jsp:param name="css" value="assets/pages/css/profile.min.css" />
	<jsp:param name="css" value="yearly_candidate_bull_production_report/report.css" />
	...
	<jsp:param name="js" value="yearly_candidate_bull_production_report/report_fieldfiller.js" />
