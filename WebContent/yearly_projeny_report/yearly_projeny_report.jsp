<jsp:include page="../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../yearly_projeny_report/yearly_projeny_report_Body.jsp" />
	<jsp:param name="css" value="assets/pages/css/profile.min.css" />
	<jsp:param name="css" value="yearly_projeny_report/report.css" />
	...
	<jsp:param name="js" value="yearly_projeny_report/report_fieldfiller.js" />
