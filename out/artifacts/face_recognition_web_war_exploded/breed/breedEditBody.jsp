...
<%
BreedDTO breedDTO;
breedDTO = (BreedDTO)request.getAttribute("breedDTO");
...
{
	formTitle = LM.getText(LC.BREED_EDIT_BREED_EDIT_FORMNAME, loginDTO);
}
else
{
	formTitle = LM.getText(LC.BREED_ADD_BREED_ADD_FORMNAME, loginDTO);
}
...
<div class="portlet box portlet-btcl">
	...
	<div class="portlet-body form">
		<form class="form-horizontal" action="BreedServlet?actionType=<%=actionName%>&identity=<%=ID%>"
...
<label class="col-sm-3 control-label">
	<%=(actionName.equals("edit"))?(LM.getText(LC.BREED_EDIT_NAMEEN, loginDTO)):(LM.getText(LC.BREED_ADD_NAMEEN, loginDTO))%>
...
<label class="col-sm-3 control-label">
	<%=(actionName.equals("edit"))?(LM.getText(LC.BREED_EDIT_NAMEBN, loginDTO)):(LM.getText(LC.BREED_ADD_NAMEBN, loginDTO))%>
	<span class="required"> * </span>
</label>
<div class="form-group ">					
...
<label class="col-sm-3 control-label">
	<%=(actionName.equals("edit"))?(LM.getText(LC.BREED_EDIT_DESCRIPTION, loginDTO)):(LM.getText(LC.BREED_ADD_DESCRIPTION, loginDTO))%>
</label>
<div class="form-group ">					
	<div class="col-sm-6 " id = 'description_div_<%=i%>'>	
		<textarea class='form-control'  name='description' id = 'description_textarea_<%=i%>' ><%=actionName.equals("edit")?(breedDTO.description):(" ")%></textarea>		
				...
				<div class="form-actions text-center">
					...
					if(actionName.equals("edit"))
					{
						out.print(LM.getText(LC.BREED_EDIT_BREED_CANCEL_BUTTON, loginDTO));
					}
					else
					{
						out.print(LM.getText(LC.BREED_ADD_BREED_CANCEL_BUTTON, loginDTO));
					}
					...
					if(actionName.equals("edit"))
					{
						out.print(LM.getText(LC.BREED_EDIT_BREED_SUBMIT_BUTTON, loginDTO));
					}
					else
					{
						out.print(LM.getText(LC.BREED_ADD_BREED_SUBMIT_BUTTON, loginDTO));
					}
					%>
					</button>
				</div>
