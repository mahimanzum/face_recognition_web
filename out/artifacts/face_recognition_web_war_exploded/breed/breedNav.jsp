...
<%@ page import="breed.BreedAnotherDBDAO"%>
		...
		<div class="form-horizontal">			
			<div class="form-body">
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.BREED_SEARCH_NAMEEN, loginDTO)%></label>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.BREED_SEARCH_NAMEBN, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.BREED_SEARCH_DESCRIPTION, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
