...
<div class="portlet box portlet-btcl">
	<div class="portlet-title">
		...
		<p style="float:right; margin:10px 5px !important;">Advanced Search</p>
		<div class="tools">
			...
			<div class="row col-lg-offset-1">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" style="margin-top: 5px;">
					<div class="col-xs-2 col-sm-4 col-md-4">
						<label for="" class="control-label pull-right"><%=LM.getText(LC.BULL_BREED_CENTRE_SEARCH_BULLTYPE, loginDTO)%></label>
					</div>
					<div class="col-xs-10 col-sm-8 col-md-8">
						<select class='form-control'  name='bull_type' id = 'bull_type' >
<%
			
			Options = CommonDAO.getOptions(Language, "select", "bull", "bullType_select_" + row, "form-control", "bullType", "any" );			
			out.print(Options);
%>
</select>
					</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" style="margin-top: 5px;">
					<div class="col-xs-2 col-sm-4 col-md-4">
						<label for="" class="control-label pull-right"><%=LM.getText(LC.BULL_BREED_CENTRE_SEARCH_BREEDTYPE, loginDTO)%></label>
					</div>
					<div class="col-xs-10 col-sm-8 col-md-8">
						<select class='form-control'  name='breed_type' id = 'breed_type' >
<%
			
			Options = CommonDAO.getOptions(Language, "select", "breed", "breedType_select_" + row, "form-control", "breedType", "any" );			
			out.print(Options);
%>
</select>
					</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" style="margin-top: 5px;">
					<div class="col-xs-2 col-sm-4 col-md-4">
						<label for="" class="control-label pull-right"><%=LM.getText(LC.BULL_BREED_CENTRE_SEARCH_CENTRETYPE, loginDTO)%></label>
					</div>
					<div class="col-xs-10 col-sm-8 col-md-8">
						<select class='form-control'  name='centre_type' id = 'centre_type' >
<%
			
			Options = CommonDAO.getOptions(Language, "select", "centre", "centreType_select_" + row, "form-control", "centreType", "any" );			
			out.print(Options);
%>
</select>
					</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" style="margin-top: 5px;">
					<div class="col-xs-2 col-sm-4 col-md-4">
						<label for="" class="control-label pull-right"><%=LM.getText(LC.BULL_BREED_CENTRE_SEARCH_GRSOFFICE, loginDTO)%></label>
					</div>
					<div class="col-xs-10 col-sm-8 col-md-8">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" style="margin-top: 5px;">
					...
					<div class="col-xs-10 col-sm-8 col-md-8">
						<input type="text" class="form-control" id="info_file" placeholder="" name="info_file">
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" style="margin-top: 5px;">
					<div class="col-xs-2 col-sm-4 col-md-4">
						<label for="" class="control-label pull-right"><%=LM.getText(LC.BULL_BREED_CENTRE_SEARCH_BULLIMAGE, loginDTO)%></label>
					</div>
					<div class="col-xs-10 col-sm-8 col-md-8">
						<input type="text" class="form-control" id="bull_image" placeholder="" name="bull_image">
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" style="margin-top: 5px;">
					<div class="col-xs-2 col-sm-4 col-md-4">
						<label for="" class="control-label pull-right"><%=LM.getText(LC.BULL_BREED_CENTRE_SEARCH_DESCRIPTION, loginDTO)%></label>
					</div>
					<div class="col-xs-10 col-sm-8 col-md-8">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-offset-3 col-xs-12 col-md-12  col-md-12 col-lg-9">
							<label for="" class="control-label col-xs-5 col-sm-5 col-md-3"><%=LM.getText(LC.GLOBAL_RECORD_PER_PAGE, loginDTO)%></label>							
