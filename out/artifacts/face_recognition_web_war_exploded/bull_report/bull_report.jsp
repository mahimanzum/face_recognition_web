<jsp:include page="../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../bull_report/bull_report_Body.jsp" />
	<jsp:param name="css" value="assets/pages/css/profile.min.css" />
	<jsp:param name="css" value="bull_report/report.css" />
	...
	<jsp:param name="js" value="bull_report/report_fieldfiller.js" />
