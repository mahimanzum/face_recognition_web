...
function PreprocessBeforeSubmiting(row, validate)
{
	...
	console.log("found date = " + document.getElementById('collectionDate_date_Date_' + row).value);
	document.getElementById('collectionDate_date_' + row).value = new Date(document.getElementById('collectionDate_date_Date_' + row).value).getTime();
	return true;
}
