<jsp:include page="../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../monthly_bulwise_ai_report/monthly_bulwise_ai_report_Body.jsp" />
	<jsp:param name="css" value="assets/pages/css/profile.min.css" />
	<jsp:param name="css" value="monthly_bulwise_ai_report/report.css" />
	...
	<jsp:param name="js" value="monthly_bulwise_ai_report/report_fieldfiller.js" />
