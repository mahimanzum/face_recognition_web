<jsp:include page="../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../monthly_candidate_bull_production_report/monthly_candidate_bull_production_report_Body.jsp" />
	<jsp:param name="css" value="assets/pages/css/profile.min.css" />
	<jsp:param name="css" value="monthly_candidate_bull_production_report/report.css" />
	...
	<jsp:param name="js" value="assets/report/buttons.print.min.js" />
	<jsp:param name="js" value="assets/report/dataTables.bootstrap.min.js" />
	...
	<jsp:param name="js" value="monthly_candidate_bull_production_report/report_fieldfiller.js" />
	<jsp:param name="js" value="pbreport/report.js" />
