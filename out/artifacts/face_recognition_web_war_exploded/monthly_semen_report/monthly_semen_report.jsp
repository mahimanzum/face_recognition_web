<jsp:include page="../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../monthly_semen_report/monthly_semen_report_Body.jsp" />
	<jsp:param name="css" value="assets/pages/css/profile.min.css" />
	<jsp:param name="css" value="monthly_semen_report/report.css" />
	...
	<jsp:param name="js" value="monthly_semen_report/report_fieldfiller.js" />
