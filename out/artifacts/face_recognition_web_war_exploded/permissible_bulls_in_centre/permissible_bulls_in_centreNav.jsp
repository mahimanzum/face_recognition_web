				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.PERMISSIBLE_BULLS_IN_CENTRE_SEARCH_BULLTYPE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<select class='form-control'  name='bull_type' id = 'bull_type' >
<%
			
			Options = Permissible_bulls_in_centreAnotherDBDAO.getOptions(Language, "select", "bull", "bullType_select_" + row, "form-control", "bullType", "any" );			
			out.print(Options);
%>
</select>
							</div>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.PERMISSIBLE_BULLS_IN_CENTRE_SEARCH_CENTRETYPE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<select class='form-control'  name='centre_type' id = 'centre_type' >
<%
			
			Options = Permissible_bulls_in_centreAnotherDBDAO.getOptions(Language, "select", "centre", "centreType_select_" + row, "form-control", "centreType", "any" );			
			out.print(Options);
%>
</select>
							</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.PERMISSIBLE_BULLS_IN_CENTRE_SEARCH_DATEOFENTRY, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.PERMISSIBLE_BULLS_IN_CENTRE_SEARCH_DATEOFEXPIRATION, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<input type="text" class="form-control" id="date_of_expiration" placeholder="" name="date_of_expiration">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.PERMISSIBLE_BULLS_IN_CENTRE_SEARCH_DESCRIPTION, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
