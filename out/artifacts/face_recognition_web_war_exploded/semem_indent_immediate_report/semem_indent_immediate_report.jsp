<jsp:include page="../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../semem_indent_immediate_report/semem_indent_immediate_report_Body.jsp" />
	<jsp:param name="css" value="assets/pages/css/profile.min.css" />
	<jsp:param name="css" value="semem_indent_immediate_report/report.css" />
	...
	<jsp:param name="js" value="semem_indent_immediate_report/report_fieldfiller.js" />
