<jsp:include page="../common/layout.jsp" flush="true">
	...
	<jsp:param name="body" value="../semen_distribution_immediate_report/semen_distribution_immediate_report_Body.jsp" />
	<jsp:param name="css" value="assets/pages/css/profile.min.css" />
	<jsp:param name="css" value="semen_distribution_immediate_report/report.css" />
	...
	<jsp:param name="js" value="semen_distribution_immediate_report/report_fieldfiller.js" />
