				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_REQUISITION_SEARCH_GROUPID, loginDTO)%></label>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_REQUISITION_SEARCH_CENTRETYPE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<select class='form-control'  name='centre_type' id = 'centre_type' >
<%
			
			Options = Semen_requisitionAnotherDBDAO.getOptions(Language, "select", "centre", "centreType_select_" + row, "form-control", "centreType", "any" );			
			out.print(Options);
%>
</select>
							</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_REQUISITION_SEARCH_BREEDTYPE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<select class='form-control'  name='breed_type' id = 'breed_type' >
<%
			
			Options = Semen_requisitionAnotherDBDAO.getOptions(Language, "select", "breed", "breedType_select_" + row, "form-control", "breedType", "any" );			
			out.print(Options);
%>
</select>
							</div>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_REQUISITION_SEARCH_NOOFDOSE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_REQUISITION_SEARCH_REQUISITIONDATE, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<input type="text" class="form-control" id="requisition_date" placeholder="" name="requisition_date">
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_REQUISITION_SEARCH_ISDELIVERED, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
								<input type="text" class="form-control" id="isDelivered" placeholder="" name="isDelivered">
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="form-group">
							<label for="" class="control-label col-md-4 col-sm-4 col-xs-4"><%=LM.getText(LC.SEMEN_REQUISITION_SEARCH_DESCRIPTION, loginDTO)%></label>
							<div class="col-md-8 col-sm-8 col-xs-8">
