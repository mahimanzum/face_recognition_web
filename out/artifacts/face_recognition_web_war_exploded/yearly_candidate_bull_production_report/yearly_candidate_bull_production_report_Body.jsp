...
<form class="form-horizontal" id="ReportForm"
			action="<%=request.getContextPath()%>/Yearly_candidate_bull_production_report_Servlet?actionType=<%=ActionTypeConstant.REPORT_RESULT%>">
<div class="portlet box portlet-btcl">
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-cubes"></i><%=LM.getText(LC.YEARLY_CANDIDATE_BULL_PRODUCTION_REPORT_OTHER_REPORT_GENERATION, loginDTO)%>
		</div>
	</div>
	<div class="portlet-body form">
		
			<input type="hidden" id="countURL" name="countURL" value="/Yearly_candidate_bull_production_report_Servlet?actionType=<%=ActionTypeConstant.REPORT_COUNT%>">
			<div class="form-body">
				<div class="row">
<!--  					<div class="col-md-6">
						<div class="col-md-8">
				...
				<div id="searchCriteria" hide = "false">
					<%@include file="yearly_candidate_bull_production_report_SearchDiv.jsp"%>
				</div>
					...
					<div class="portlet-title">
						<div class="caption">
							<i class="icon-settings"></i> <span id = "report-name"
								...
								<%=LM.getText(LC.YEARLY_CANDIDATE_BULL_PRODUCTION_REPORT_OTHER_YEARLY_CANDIDATE_BULL_PRODUCTION_REPORT, loginDTO)%>   by <%=userfullName%>, <%=centreName%>
								</span>
						</div>
						<div class="tools"></div>
					</div>
