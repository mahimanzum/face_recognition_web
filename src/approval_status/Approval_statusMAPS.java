...
public class Approval_statusMAPS 
{
	...
	private static Approval_statusMAPS self = null;
	
	private Approval_statusMAPS()
	{
	...
	public static Approval_statusMAPS GetInstance()
	{
		if(self == null)
		{
			self = new Approval_statusMAPS ();
		}
		return self;
	}
