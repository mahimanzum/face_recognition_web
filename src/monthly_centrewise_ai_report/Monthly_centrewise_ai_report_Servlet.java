package monthly_centrewise_ai_report;
...
@WebServlet("/Monthly_centrewise_ai_report_Servlet")
public class Monthly_centrewise_ai_report_Servlet  extends HttpServlet {
	/**
	 * 
	 */
	...
	public Monthly_centrewise_ai_report_Servlet(){
			...
			throws ServletException, IOException 
	{
		...
		Display[0][4] = LM.getText(LC.MONTHLY_CENTREWISE_AI_REPORT_SELECT_CENTRENAME, loginDTO);
		Display[1][4] = LM.getText(LC.MONTHLY_CENTREWISE_AI_REPORT_SELECT_BULLNAME, loginDTO);
		Display[2][4] = LM.getText(LC.MONTHLY_CENTREWISE_AI_REPORT_SELECT_TOTALAI, loginDTO);
		Display[3][4] = LM.getText(LC.MONTHLY_CENTREWISE_AI_REPORT_SELECT_ENTRYDATE, loginDTO);

		
		if(PermissionRepository.checkPermissionByRoleIDAndMenuID(userDTO.roleID, MenuConstants.MONTHLY_CENTREWISE_AI_REPORT_DETAILS))
		{
			
			if(ActionTypeConstant.REPORT_PAGE.equals(actionType)){
				
				request.getRequestDispatcher("/monthly_centrewise_ai_report/monthly_centrewise_ai_report.jsp").forward(request, response);
