 ...
 */
@WebServlet("/simpleCaptchaServlet")
public class SimpleCaptchaServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Captcha captcha = new Captcha.Builder(_width, _height).addText(new DefaultTextProducer()).addBackground()
				.gimp().addBorder().build(); // Required.

		//CaptchaServletUtil.writeImage(resp, captcha.getImage());
		CaptchaServletUtil.writeImage(resp.getOutputStream(), captcha.getImage());
