package yearly_bulwise_ai_report;
...
@WebServlet("/Yearly_bulwise_ai_report_Servlet")
public class Yearly_bulwise_ai_report_Servlet  extends HttpServlet {
	/**
	 * 
	 */
	...
	public Yearly_bulwise_ai_report_Servlet(){
			...
			throws ServletException, IOException 
	{
		...
		Display[0][4] = LM.getText(LC.YEARLY_BULWISE_AI_REPORT_SELECT_CENTRENAME, loginDTO);
		Display[1][4] = LM.getText(LC.YEARLY_BULWISE_AI_REPORT_SELECT_BULLNAME, loginDTO);
		Display[2][4] = LM.getText(LC.YEARLY_BULWISE_AI_REPORT_SELECT_NOOFAI, loginDTO);
		Display[3][4] = LM.getText(LC.YEARLY_BULWISE_AI_REPORT_SELECT_ENTRYDATE, loginDTO);

		
		if(PermissionRepository.checkPermissionByRoleIDAndMenuID(userDTO.roleID, MenuConstants.YEARLY_BULWISE_AI_REPORT_DETAILS))
		{
			
			if(ActionTypeConstant.REPORT_PAGE.equals(actionType)){
				
				request.getRequestDispatcher("/yearly_bulwise_ai_report/yearly_bulwise_ai_report.jsp").forward(request, response);
